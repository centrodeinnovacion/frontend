<template>
  ...
  <div id="app" class="container-fluid">
    ...
    <footer class="" v-if="route !== 'home' && route !== 'about'">
      ...
      <div class="d-flex fixed-bottom footer-copyright justify-content-center align-content-center text-center py-3">© 2018.
        <a href=""> Términos y condiciones de uso.</a>
      </div>
    </footer>
  ...
  export default {
    computed: {
      ...mapState({
        ...
        back: state => state.route.meta.back,
        forward: state => state.route.meta.forward
      })
    }
  }
</script>
