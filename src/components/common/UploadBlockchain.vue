<template>
  <div class="upload d-flex align-items-start mt-6">
    ...
    <div class="pl-6">
      ...
      Blockchain, a través de este Kit. Esta transferencia es identificada con otro hash.</p>
      ...
      <p class="mb-5 pb-5">Haga clic en el hash para ir a Ropsten en donde se muestra que efectivamente la transacción se ha realizado.</p>
      <p></p>
    </div>
  </div>
</template>
